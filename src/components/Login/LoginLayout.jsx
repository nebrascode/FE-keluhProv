...
export default function Login() {
    ...
    const dummyAdmins = [
        { email: 'super_admin@gmail.com', password: 'password', is_super_admin: true },
        { email: 'admin_pandeglang@gmail.com', password: 'password' },
        { email: 'admin_lebak@gmail.com', password: 'password' },
        { email: 'admin_serang@gmail.com', password: 'password' }
    ];
