  ...
  return (
    <div className="w-full h-20 bg-white flex justify-between items-center px-6 md:px-12">
      ...
      <div className="hidden md:flex">
        <button
          className="p-2.5 bg-main-color hover:bg-main-lighter rounded-full flex justify-center items-center"
          onClick={() => navigate("/login")}
        >
          <div className="text-zinc-900 text-xl font-normal font-montserrat leading-tight px-4">
            Login
          </div>
        </button>
      </div>
